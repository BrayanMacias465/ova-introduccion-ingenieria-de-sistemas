...
export class UnidadCuatroTopicoCuatroComponent {
  menu: any[] = [];
  ...
  paginaSiguiente(): void {
    this.router.navigateByUrl('/derechos-de-autor/preguntas-frecuentes-sobre-derecho-de-autor');
  }

  paginaAnterior(): void {
    this.router.navigateByUrl('/derechos-de-autor/normatividad-de-derechos-de-actor-y-propiedad-intelectual');
  }
}
